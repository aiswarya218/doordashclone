...
function areAnagrams(str1, str2) {
    ...
    const cleanAndSort = (str) => {
        ...
        // split into array, sort, and join back into a string.
...
console.log("Is 'iceman' an anagram of 'cinema'? " + areAnagrams("iceman", "cinema")); // Should be: true
console.log("Is 'hello' an anagram of 'world'? " + areAnagrams("hello", "world"));   // Should be: false


//DESTRUCTURING
const fruits = ["apple", "banana", "cherry", "date"];
const [favFruit, ...otherFruits] = fruits;

console.log(favFruit);    // Output: apple
