...
/**
 * Calculates the remainder of the division of two numbers using the modulus operator.
 * @param {number} dividend - The number to be divided.
 * @param {number} divisor - The number that divides.
...
/**
 * Finds the average (mean) of an array of numbers. 
...
// --- 3. Add two matrices ---
/**
 * Adds two matrices (2D arrays) of the same dimensions.
 * @param {number[][]} matrixA - The first matrix.
 * @param {number[][]} matrixB - The second matrix.
 * @returns {number[][]} The resulting matrix sum, or null if dimensions don't match.
 */
 ...
 * @param {number} breadth - The breadth (width) of the rectangle.
...
/**
 * Checks if a square matrix is a diagonal matrix (all non-diagonal elements are zero).
 * @param {number[][]} matrix - The matrix (2D array).
 * @returns {boolean} True if it is a diagonal matrix, false otherwise.
 */
...
/**
 * Checks if a square matrix is an identity matrix (diagonal is 1s, rest are 0s).
 * @param {number[][]} matrix - The matrix (2D array).
 * @returns {boolean} True if it is an identity matrix, false otherwise.
 */
...
/**
 * Calculates the transpose of a matrix (swaps rows and columns).
...
/**
 * Finds the most frequently occurring value in an array of numbers.
 * @param {number[]} arr - The array of numbers.
 * @returns {number|null} The most repeated value, or null if the array is empty.
 */
...
/**
 * Approximates the derivative of f(x) = x^n at a given point x using the finite difference method.
 * The derivative of f(x) is approximately (f(x + h) - f(x)) / h.
 * The exact derivative for f(x)=x^n is n * x^(n-1).
 * @param {number} n - The exponent.
 * @param {number} x - The point at which to evaluate the derivative.
 * @param {number} h - The small change in x (step size).
...
/**
 * Calculates the area of a triangle using the formula: Area = 0.5 * base * height.
 ...
 * @param {number} num - The number to check.
 * @returns {boolean} True if it is an Armstrong number.
 */
...
/**
 * Checks if a number is a perfect number (equal to the sum of its proper positive divisors).
 * @param {number} num - The number to check.
 * @returns {boolean} True if it is a perfect number.
 */
 ...
 * @returns {string} The binary representation string.
 */
...
/**
 * Finds the Greatest Common Divisor (GCD) of two non-negative numbers.
...
/**
 * Finds the Least Common Multiple (LCM) of two numbers using the GCD relationship:
 * LCM(a, b) = (|a * b|) / GCD(a, b)
 * @param {number} a - The first number.
 * @param {number} b - The second number.
 ...
 * @param {number} limit - The upper bound for finding prime numbers.
 ...
 * @returns {number[]} A new array with unique elements.
 */
...
/**
 * Simplifies a fraction to its lowest terms by dividing the numerator and denominator by their GCD.
 * @param {number} numerator - The numerator.
 * @param {number} denominator - The denominator.
 * @returns {{numerator: number, denominator: number}} An object representing the simplified fraction.
 */
...
/**
 * Finds the range of an array of numbers (max value - min value).
 * @param {number[]} arr - The array of numbers.
 * @returns {number|null} The range, or null if the array is empty.
 */
